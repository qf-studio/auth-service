...
// DPoPConfig holds DPoP (Demonstration of Proof-of-Possession) settings.
type DPoPConfig struct {
	Enabled   bool          // DPOP_ENABLED: whether DPoP proof validation is active
	NonceTTL  time.Duration // DPOP_NONCE_TTL: lifetime of server-issued DPoP nonces
	JTIWindow time.Duration // DPOP_JTI_WINDOW: replay window for DPoP proof jti values
}
